...
/**
 ...
 就业班( 4个月 )：iOS开发 + swift语言 + HTML  + flutter
 3>.学习方法：
 1).专心听讲：注重听懂、理解
...
/**
 ...
 3>.进制转换：
 大->小：除k取余法/底部是高位、上部是低位（k表示小进制）
 小->大：从低位起k的n（n从0开始）次幂相加
...
/**
 ...
 1)原码：将一个数的真值的绝对值转为二进制，存储的八位内存空间，最高位存储符号位，0表示正数，1表示负数，其余7位用来存储真值的绝对值的二进制表示形式
